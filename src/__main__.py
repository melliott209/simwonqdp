...
def generateSample(sampleList):
    ...
    for datapoint in firstSample:
        ...
        if datapoint.getType() == "Hole" and type(datapoint.getDia()["Measured"]) != str:
            minimum = datapoint.getDia()["Measured"]
            maximum = datapoint.getDia()["Measured"]
            print('original min is ' + str(minimum) + '\noriginal max is ' + str(maximum))
            for sample in sampleList:
            ...
            for sample in sampleList:
                ...
                if value < minimum:
                    print('new min!')
                    minimum = value
                    print('new min is ' + str(minimum))
                if value > maximum:
                    print('new max!')
                    maximum = value
                    print('new max is ' + str(maximum))
            randValue = round(random.uniform(minimum,maximum),3)
            print('random value between ' + str(minimum) + ' and ' + str(maximum) + ' is ' + str(randValue))
...
ini_parts = open("config/parts.ini","r")
...
# Create window
window = tk.Tk()
window.title("Simwon QDP v1.0.0")
window.iconphoto(False, tk.PhotoImage(file='res/SimwonAmerica-Logo2.png'))
...
tempLabel = tk.Label(tabAdd, text="Coming Soon!")
tempLabel.grid(row=0,column=0,sticky='nsew')
